...
Меня задолбало платить 500-1000 ₽/мес за VPN, который раз в день выкидывает с 403 и ломает рабочий цикл. Каждый реконнект — это минут 10 выкинутого времени, и чем чаще — тем больнее. В какой-то момент подсчёт «сколько я заплатил за нестабильность за полгода» стал плохо смотреться рядом с ценой собственного VPS.

Проект — не для денег (MIT, поддержка через issues). Хотелось, чтобы начинающему разработчику в РФ (каким я был ещё год назад) не приходилось тратить день на танцы с клиентами и антивирусами.
