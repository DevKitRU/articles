...
Я не профессиональный разработчик. Основная работа — инженер-котельщик (техобслуживание, диагностика котлов). Последние несколько месяцев осваиваю программирование через Claude Code. Подписка Claude Pro стала рабочим инструментом.

Дальше классическая проблема: **подписка есть, работать через публичный VPN нормально не получается — логин в Anthropic слетает раз в день, приходится ловить кривые реконнекты**. Плюс параллельно нужно играть в STALCRAFT и открывать mini app газсервис-бота в Telegram — эти сервисы работают только с российским IP, в Hiddify с «Russia bypass» они тоже ломались.

Потратил условный «один день» (по факту ~10 часов на Windows + часть ночи) на настройку своего VPN с нуля — разобрался со sing-box, Windows Service, routing rules под РФ-специфику. И собрал всё в публичный open-source репо чтобы другим не тратить столько же.
