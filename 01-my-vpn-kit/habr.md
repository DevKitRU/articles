...
2. **iPhone (с Mac)** — Shadowrocket настраивал сидя за Mac, где VPN уже работал. Через буфер обмена (iCloud синхронизировал VLESS-ссылку между Mac и iPhone) + инструкцию от Claude.
